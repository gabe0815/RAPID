          ...
          for (i in 1:strainNumber){
            ...
            if(is.na(s)==FALSE){
              ...
              if (is.na(trackDataCollector[[s]])==FALSE){
                numberColumns <- 12 # entries per data point: sampleID,birthTimeStamp,currentTimestamp,trackLengthBefore,trackAreaBefore,trackLengthAfter,trackAreaAfter,trackVersion,trackEdgeBefore,trackContoursBefore,trackEdgeAfter,trackContoursAfter
                ...
                if (numberRows==round(numberRows)){
                  ...
                  tryCatch({censoredUnzeroedRapidData[[sortedDataListCounter]] <- c(toString(thisSampleSorted[[1]][1]),approx(thisSampleSorted[,8],thisSampleSorted[,7],xout=seq(0,21,1/24)))},error=function(cond){print(paste0("faulty dataset in trackDataCollector[[",toString(s),"]] ",cond))})
...
plotAnova <- function(groupwiseDataCollector_statData){
  ...
  #load(file="/media/imagesets04/20160321_FIJI_analysis_testing/anovaDataCollector.rda")
...
plotMeanStDev <- function(groupwiseDataCollector_statData){
  ...
  #load(file="/media/imagesets04/20160321_FIJI_analysis_testing/meanCollector.rda")
  #load(file="/media/imagesets04/20160321_FIJI_analysis_testing/stdevCollector.rda")
...
removeEmptyTimepoints <- function(singleSample){
	singleSample <- singleSample[singleSample[,7]<40000,] # upper cut-off X6 <15000
	if(length(singleSample)>1){
		if(length(singleSample[,7])>3){
			rem <- FALSE
			remList <- NULL
			for (i in length(singleSample[,7]):2){ # find first zero y after last positive value
				if((is.na(singleSample[i,7]) == FALSE) && (is.na(singleSample[i-1,7]) == FALSE)){ 
					if((singleSample[i,7]==-1) && (singleSample[i-1,7]>-1) && (rem == FALSE)){  
						rem <- TRUE
					}else if ((rem == TRUE) && (singleSample[i,7]==-1)){
						remList <- c(remList,i)
					}
				}
			}
...
columToAnalyze <<- 7 # 6=
correctTrackVersionString <<- "trackVersion.v11"

# enter RAPID source and output directories here
# usage
  #summarizeTracks("/RAPID/input/dir","/result/output/dir")

#summarizeTracks("/media/imagesets04/20151203_vibassay_set2","/home/jhench/mac/Documents/sync/lab_journal/2016/data201603/Track_Length_Analysis/Rdata_20151203_vibassay_set2/")
#summarizeTracks("/media/imagesets04/20160122_vibassay_set3","/home/jhench/mac/Documents/sync/lab_journal/2016/data201603/Track_Length_Analysis/Rdata_20160122_vibassay_set3/")
# summarizeTracks("/media/imagesets04/20160217_vibassay_set4","/home/jhench/mac/Documents/sync/lab_journal/2016/data201603/Track_Length_Analysis/Rdata_20160217_vibassay_set4/")
# summarizeTracks("/media/imagesets04/20160311_vibassay_set5","/home/jhench/mac/Documents/sync/lab_journal/2016/data201603/Track_Length_Analysis/Rdata_20160311_vibassay_set5/")
# summarizeTracks("/media/imagesets04/20160406_vibassay_set6","/home/jhench/mac/Documents/sync/lab_journal/2016/data201603/Track_Length_Analysis/Rdata_20160406_vibassay_set6/")
# summarizeTracks("/media/imagesets04/20160504_vibassay_set7","/home/jhench/mac/Documents/sync/lab_journal/2016/data201603/Track_Length_Analysis/Rdata_20160504_vibassay_set7/")
# summarizeTracks("/media/imagesets04/20160615_vibassay_set8","/home/jhench/mac/Documents/sync/lab_journal/2016/data201603/Track_Length_Analysis/Rdata_20160615_vibassay_set8/")
# summarizeTracks("/media/imagesets04/20160720_vibassay_set9","/home/jhench/mac/Documents/sync/lab_journal/2016/data201603/Track_Length_Analysis/Rdata_20160720_vibassay_set9/")
    #summarizeTracks("/media/imagesets04/20160217_vibassay_set4","/media/imagesets04/20160321_FIJI_analysis_testing/")
summarizeTracks("/mnt/4TBraid04/imagesets04/20160810_vibassay_set10","/home/jhench/mac/Documents/sync/lab_journal/2016/data201603/Track_Length_Analysis/Rdata_20160810_vibassay_set10/")
