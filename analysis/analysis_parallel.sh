...
find  $IMAGEPATH -name "imgseries_h264.AVI" | parallel -j 4 "if [ ! -f {}_parameters.txt ]; then ~/applications/RAPID/analysis/minimumProjections05.py {}; else echo skipping {} ;fi"
