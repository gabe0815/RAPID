...
find  $IMAGEPATH -name "imgseries_h264.AVI" | parallel -P 8 "if [ ! -f {}_parameters.txt ]; then ~/applications/RAPID/analysis/minimumProjections05.py {} && ~/applications/RAPID/analysis/trackLength.py {//}; else echo skipping {} ;fi"
